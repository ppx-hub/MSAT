...
class VGG16(nn.Module):
    ...
    def forward(self, input, compute_efficiency=None):
        if compute_efficiency is True:
            ...
            firing_rate = [
                0.06102975457906723, 0.11190050840377808, 0.12278002500534058,
                0.07784731686115265, 0.08431008458137512, 0.0826566144824028,
                0.052342068403959274, 0.0550847090780735, 0.04042663797736168,
                0.033038802444934845, 0.06575892865657806, 0.05920432507991791,
                0.053282544016838074
            ] # len is 13
            snn_op = 0
            index = 1
