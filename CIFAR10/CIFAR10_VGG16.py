...
class VGG16(nn.Module):
    ...
    def forward(self, input, compute_efficiency=None):
        if compute_efficiency is True:
            ...
            firing_rate = [
                0.062289003282785416, 0.09638527780771255, 0.1177188828587532,
                0.06692903488874435, 0.07196145504713058, 0.06247413158416748,
                0.043196406215429306, 0.05118325725197792, 0.041658323258161545,
                0.06960798054933548, 0.11506533622741699, 0.11693709343671799,
                0.039231475442647934
            ] # len is 13
            snn_op = 0
            index = 1
